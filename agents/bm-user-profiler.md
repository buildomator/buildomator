...
Read the user-profiling reference document at `${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/plugins/cache/gsd-plugin/current}/references/user-profiling.md` to load:
