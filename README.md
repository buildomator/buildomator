...
Recent: v3.5.0 began tracking gsd-core 1.5.x (lazy MVP refs, low-effort status reads); v3.4.11 fixed main-vs-master branch drift. Full history in [CHANGELOG.md](./CHANGELOG.md).
