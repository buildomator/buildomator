 ...
 */
export declare enum GSDEventType {
 ...
 */
export type InitStepName = 'setup' | 'config' | 'project' | 'research-stack' | 'research-features' | 'research-architecture' | 'research-pitfalls' | 'synthesis' | 'requirements' | 'roadmap';
/**
 ...
 */
export declare enum PhaseStepType {
    Discuss = "discuss",
    Research = "research",
    Plan = "plan",
