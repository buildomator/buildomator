...
function workflowBool(v, defaultVal) {
 ...
 */
export const checkConfigGates = async (args, projectDir) => {
    const config = await loadConfig(projectDir);
    const wf = {
        ...config.workflow,
    };
    const root = config;
    const contextWindow = typeof root.context_window === 'number' ? root.context_window : 200000;
...
//# sourceMappingURL=config-gates.js.map