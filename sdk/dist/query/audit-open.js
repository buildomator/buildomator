 ...
 */
export function auditOpenArtifacts(projectDir, workstream) {
    ...
    const has_scan_errors = itemArrays.some(arr => arr.some(i => i.scan_error === true));
    return {
 ...
 */
export const auditOpen = async (args, projectDir, workstream) => {
...
//# sourceMappingURL=audit-open.js.map