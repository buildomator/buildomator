...
export function stateReplaceFieldWithFallback(content, primary, fallback, value) {
...
export function computeProgressPercent(completedPlans, totalPlans, completedPhases, totalPhases) {
...
export function shouldPreserveExistingProgress(existingProgress, derivedProgress) {
...
export function normalizeProgressNumbers(progress) {
...
//# sourceMappingURL=state-document.js.map