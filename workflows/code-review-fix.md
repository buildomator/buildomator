...
- gsd:bm-code-fixer: Applies fixes to code review findings
- gsd:bm-code-reviewer: Reviews source files for bugs and issues
</available_agent_types>
...
```text
Agent(subagent_type="gsd:bm-code-fixer", prompt="
<files_to_read>
${REVIEW_PATH}
</files_to_read>
