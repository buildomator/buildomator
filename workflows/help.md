...
Usage: `/gsd:plan-phase --research-phase 2`, research only on phase 2 (auto-uses existing `RESEARCH.md` if present; pass `--research` to refresh or `--view` to print)
