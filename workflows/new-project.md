...
", subagent_type="gsd:bm-project-researcher", model="{researcher_model}", description="Stack research")
...
", subagent_type="gsd:bm-project-researcher", model="{researcher_model}", description="Features research")
...
", subagent_type="gsd:bm-project-researcher", model="{researcher_model}", description="Architecture research")
...
", subagent_type="gsd:bm-project-researcher", model="{researcher_model}", description="Pitfalls research")
```
...
- Re-spawn roadmapper with revision context:
  ...
  ", subagent_type="gsd:bm-roadmapper", model="{roadmapper_model}", description="Revise roadmap")
  ```
