...
Plan: —
Status: Awaiting next milestone
Last activity: 2026-07-19 - Completed quick task 260718-vxw (ported upstream gsd-core 1.7.0 Tier-1 correctness fixes; verified 8/8)
...
| 260718-vhs | Triage upstream gsd-core v1.7.0 for Claude-relevant cherry-picks (follow-up to 260701-gbo; provenance 1.6.1). 13 candidates assessed against our code via 4 parallel agents: ADOPT #2018/#1581/#1988 + #1154+#1820; ADAPT #1779/#1561/#1729/#1866; design-decision #2022; SKIP #1787/#1855/#2002+#2036/#1143. Survey only, no product code changed. Findings + porting tiers in the task dir; deferred/skip actions recorded in upstream-deferred.md. | 2026-07-18 | 1e43297 | Survey | [260718-vhs-triage-upstream-gsd-core-1-7-0-claude-re](./quick/260718-vhs-triage-upstream-gsd-core-1-7-0-claude-re/) |
| 260718-vxw | Port upstream gsd-core 1.7.0 Tier-1 correctness fixes into both CJS+SDK resolvers: #2018 surface empty-manifest agent-delete guard (CJS), #1581 config-set keeps non-finite (Infinity) + string-typed keys (project_code) verbatim, #1988 pair *-SUMMARY.md to a real PLAN before counting phase completion. Fix 3 wired through ALL completion consumers incl. the independent duplicate scanners in init.cjs/init-complex.ts/roadmap.ts (roadmap.analyze/init-manager/init-progress no longer flip complete off a stray summary). New regressions 3/3+4/4+6/6, SDK unit 1833 green, config-set + roadmap.update-plan-progress golden parity green; sdk/dist + dist/bm regenerated, build-bm --check PASS. 13 pre-existing integration failures confirmed unrelated (archived-v4.1 CJS/SDK milestone-parse divergence). Plan-checker caught a real gap (3 unreached consumers) on iter 1. | 2026-07-19 | da101c6 | Verified | [260718-vxw-port-upstream-gsd-core-1-7-0-tier-1-corr](./quick/260718-vxw-port-upstream-gsd-core-1-7-0-tier-1-corr/) |
