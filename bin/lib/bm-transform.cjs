...
// Rewrite the `/gsd:` token wherever it appears: command self-references
// (/gsd:plan-phase, /gsd:capture, /gsd:local-patches, /gsd:edit-phase,
// /gsd:extract-learnings) and plugin-owned artifact path segments. This is safe
// because every token that must survive lacks the `/gsd:` substring: gsd://
...
/**
 * Rewrite the `/gsd:` token to `/bm:` wherever it appears.
