...
- bm:gsd-phase-researcher — Researches specific questions and returns concise findings
</available_agent_types>
...
```bash
bm-sdk query commit "docs: capture exploration — {topic_slug}" --files {file_list}
```
