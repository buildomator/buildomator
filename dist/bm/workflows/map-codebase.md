...
Spawn 4 parallel bm-codebase-mapper agents using the Agent tool with `subagent_type="bm:bm-codebase-mapper"`, `model="{mapper_model}"`, and `run_in_background=true`.
