...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /bm:plan-phase --research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/plugins/cache/gsd-plugin/current}/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/plugins/cache/gsd-plugin/current}/templates/discovery.md structure:
...
1. **Scope the discovery** using ${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/plugins/cache/gsd-plugin/current}/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/plugins/cache/gsd-plugin/current}/templates/discovery.md
...
Use ${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/plugins/cache/gsd-plugin/current}/templates/discovery.md.
...
1. Discuss phase context (/bm:discuss-phase [current-phase])
2. Create phase plan (/bm:plan-phase [current-phase])
