...
<trigger>
This workflow executes when `--power` flag is present in ARGUMENTS to `/bm:discuss-phase`.
...
Consider running /bm:discuss-phase {N} again to refine before planning.
```
