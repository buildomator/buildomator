...
- bm:bm-doc-writer — Writes and updates project documentation files
- bm:bm-doc-verifier — Verifies factual claims in docs against the live codebase
</available_agent_types>
...
```
Agent(
  subagent_type="bm:bm-doc-writer",
