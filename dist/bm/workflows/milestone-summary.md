...
4. If nothing found: error "No milestone found. Run /bm:new-project or /bm:new-milestone first."
...
If the user is done:
- Suggest next steps: `/bm:new-milestone`, `/bm:progress`, or sharing the summary with the team
