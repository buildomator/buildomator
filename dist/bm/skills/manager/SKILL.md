...
Project context, phase list, dependencies, and recommendations are resolved inside the workflow using `bm-sdk query init.manager`. No upfront context loading needed.
</context>
