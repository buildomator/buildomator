...
Project context, phase list, and state are resolved inside the workflow using init commands (`bm-sdk query init.milestone-op`, `bm-sdk query roadmap.analyze`). No upfront context loading needed.
</context>
