...
**Orchestrator role:** Parse arguments, validate phase, research domain (unless skipped), spawn bm-planner, verify with bm-plan-checker, iterate until pass or max iterations, present results.
</objective>
