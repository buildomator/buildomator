...
Review and comment on the plan in your browser, then import it back via /bm:import --from.

⚠ BETA: ultraplan is in research preview. Use /bm:plan-phase for stable local planning.
