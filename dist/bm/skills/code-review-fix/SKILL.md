...
<execution_context>
@${CLAUDE_PLUGIN_ROOT}/workflows/code-review-fix.md
</execution_context>
...
Context files (CLAUDE.md, REVIEW.md, phase state) are resolved inside the workflow via `bm-sdk query init.phase-op` and delegated to agent via config blocks.
</context>
