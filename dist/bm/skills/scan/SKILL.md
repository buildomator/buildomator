---
name: gsd:scan
description: Rapid codebase assessment — lightweight alternative to /bm:map-codebase
...
Lightweight alternative to `/bm:map-codebase` — spawns one mapper agent instead of four parallel ones.
</objective>
