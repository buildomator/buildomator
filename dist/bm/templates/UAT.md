...
- This section feeds directly into /bm:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /bm:plan-phase --gaps with root causes
...
**Creation:** When /bm:verify-work starts new session
...
- `/bm:verify-work {phase}` picks up from first pending/blocked test
