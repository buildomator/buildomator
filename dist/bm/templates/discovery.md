...
For deep ecosystem research ("how do experts build this"), use `/bm:plan-phase --research-phase` which produces RESEARCH.md.
...
- Use `/bm:plan-phase --research-phase` for these
</guidelines>
