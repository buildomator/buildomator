...
*Phase: [XX-name]*
*Spec created: [date]*
*Next step: /bm:discuss-phase [X] — implementation decisions (how to build what's specified above)*
```
...
*Next step: /bm:discuss-phase 3 — implementation decisions (card layout, loading skeleton, etc.)*
```
...
*Spec created: 2025-01-20*
*Next step: /bm:discuss-phase 2 — implementation decisions (progress reporting, flag design, etc.)*
```
