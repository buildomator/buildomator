...
export declare function legacyAgentName(name: string): string;
export declare function lookupByAgentName<T>(map: Record<string, T> | undefined | null, name: string): T | undefined;
