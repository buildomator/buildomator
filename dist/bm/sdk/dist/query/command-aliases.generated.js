...
export const VERIFY_COMMAND_ALIASES = [
...
export const PHASE_COMMAND_ALIASES = [
...
export const PHASES_COMMAND_ALIASES = [
...
export const VALIDATE_COMMAND_ALIASES = [
...
export const ROADMAP_COMMAND_ALIASES = [
...
export const INIT_SUBCOMMANDS = new Set(INIT_COMMAND_ALIASES.map((entry) => entry.subcommand));
export const PHASE_SUBCOMMANDS = new Set(PHASE_COMMAND_ALIASES.map((entry) => entry.subcommand));
export const PHASES_SUBCOMMANDS = new Set(PHASES_COMMAND_ALIASES.map((entry) => entry.subcommand));
export const VALIDATE_SUBCOMMANDS = new Set(VALIDATE_COMMAND_ALIASES.map((entry) => entry.subcommand));
export const ROADMAP_SUBCOMMANDS = new Set(ROADMAP_COMMAND_ALIASES.map((entry) => entry.subcommand));
//# sourceMappingURL=command-aliases.generated.js.map