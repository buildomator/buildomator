 ...
 */
export const verifyPlanStructure = async (args, projectDir) => {
 ...
 */
export const verifyPhaseCompleteness = async (args, projectDir, workstream) => {
    const phase = args[0];
    if (!phase) {
 ...
 * @throws GSDError with Validation classification if file path missing
 */
export const verifyArtifacts = async (args, projectDir) => {
 ...
 */
export const verifyCommits = async (args, projectDir) => {
    if (args.length === 0) {
 ...
 */
export const verifyReferences = async (args, projectDir) => {
    const filePath = args[0];
    if (!filePath) {
        throw new GSDError('file path required', ErrorClassification.Validation);
    }
 ...
 */
export const verifySummary = async (args, projectDir) => {
 ...
 */
export const verifyPathExists = async (args, projectDir) => {
 ...
 */
export const verifySchemaDrift = async (args, projectDir, workstream) => {
    ...
    function filesModifiedFromFrontmatter(fm) {
