...
// [PLUGIN PATCH] When the SDK runs under buildomator/buildomator, gsd-tools.cjs and
...
const PLUGIN_FLAT_LEGACY_ASSET_SUBPATH: Record<LegacySdkAsset, string> = {
  'gsd-tools': 'gsd-tools.cjs',
  'core-cjs': join('lib', 'core.cjs'),
};

function pluginFlatLegacyAsset(asset: LegacySdkAsset): string | null {
