...
1. Run `/bm:verify-work` — verification finds gaps
2. Review gaps — determine which are intentional deviations
3. Add override entries to VERIFICATION.md frontmatter
4. Re-run `/bm:verify-work` — overrides are applied, remaining gaps shown
...
During `/bm:audit-milestone`, overrides are surfaced in the audit report:
