---
name: bm-pattern-mapper
description: Analyzes codebase for existing patterns and produces PATTERNS.md mapping new files to closest analogs. Read-only codebase analysis spawned by /bm:plan-phase orchestrator before planning.
...
Spawned by `/bm:plan-phase` orchestrator (between research and planning steps).
